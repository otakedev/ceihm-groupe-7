...
headline1White(context) =>
    Theme.of(context).textTheme.headline1.apply(color: kColorWhite);
headline2White(context) =>
    Theme.of(context).textTheme.headline2.apply(color: kColorWhite);
headline3White(context) =>
    Theme.of(context).textTheme.headline3.apply(color: kColorWhite);
headline4White(context) =>
    Theme.of(context).textTheme.headline4.apply(color: kColorWhite);
headline5White(context) =>
    Theme.of(context).textTheme.headline5.apply(color: kColorWhite);
headline6White(context) =>
    Theme.of(context).textTheme.headline6.apply(color: kColorWhite);
bodyText1White(context) =>
    Theme.of(context).textTheme.bodyText1.apply(color: kColorWhite);
bodyText2White(context) =>
    Theme.of(context).textTheme.bodyText2.apply(color: kColorWhite);
